...
(async () => {
  ...
  await ctx.request.post(API + '/auth/send-code', { data: { email: 'xinhua1001@outlook.com' }, headers: { 'Content-Type': 'application/json' } });
  await ctx.request.post(API + '/auth/verify-code', { data: { email: 'xinhua1001@outlook.com', code: '000000' }, headers: { 'Content-Type': 'application/json' } });
